...
?>
<div class="jumbotron text-center bg-dark text-white" style="background:url('<?php echo $bg_url ?>');background-size: cover; background-position:center center; background-attachment:fixedX;">
  <h1 class="display-3 my-0" style="opacity: .9">BOSS</h1>
