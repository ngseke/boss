...
?>
<div class="d-none jumbotron-fluid text-center bg-dark <?php echo 'text-'.$slogan_color ?>" style="background:url('<?php echo $bg_url ?>');background-size: cover; background-position:center center; background-attachment:fixed;">
